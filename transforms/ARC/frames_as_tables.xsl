            ...
            <xsl:when test="routine!=''">
             ...
             <xsl:when test="url!=''">
                ...
                <xsl:attribute name="fragmenturl">
                    ...
                    <xsl:variable name="urlCheck" select="url"/>
                    <xsl:choose>
                        <xsl:when test="not(contains($urlCheck, '?'))">?&amp;formToken=<xsl:value-of select="$csrfToken"/></xsl:when>
                        <xsl:otherwise>&amp;formToken=<xsl:value-of select="$csrfToken"/></xsl:otherwise>
                    </xsl:choose>
                </xsl:attribute>
            </xsl:when>
