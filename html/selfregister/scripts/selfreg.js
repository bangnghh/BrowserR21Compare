function getCustomerNo(thisEvent)
       		 {
       		   if ( validateCustomerNumber( thisEvent ))
         			...
         			var currentTime = new Date()
          			...
          			window.document.getElementById( "userId" ).innerText = "Your login Id for internet banking is : " + tDay;
          			window.document.getElementById( "userInfo" ).innerText = ".  Please complete and submit the form inorder to activate the User Id."
          		}
          	else
          		{
