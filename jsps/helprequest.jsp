...
<%@ page import="com.temenos.logger.logging.facade.Logger" %>
<%@ page import="com.temenos.logger.logging.facade.LoggerFactory" %>

<%-- Browser parameters are needed to decide if obfuscation is on
	(for ARC-IB deployment) or off (for internal Browser deployment).  --%>
<%
        Logger LOGGER = LoggerFactory.getLogger("helprequest");
