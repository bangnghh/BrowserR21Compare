...
function raisePanel(tabnumber,propertyName)
{
	...
	var tabHeader = FragmentUtil.getElement("headtab_" + currentForm_GLOBAL);
...
function getChildElementFromParent(parentId, childId, childTag)
{
	...
	if(!parentItem){			 
		return childElement;	// We don't want to be accessing objects with null reference to avoid possible exceptions
	}
