...
function resizeEnquiry() {
	...
	if( multiPaneFormObj != null && currentForm_GLOBAL != "appreq")
	{
		...
		parentId = "pane_"+ currentForm_GLOBAL;
		if(top.noFrames){
			parentId += "_" + Fragment.getCurrentFragmentName();
		}
	}
	
	if ( (tabHeader) && (getChildElementFromParent(parentId, "enquiryHeadingScroller", "div")) )
	{
		headingDiv = getChildElementFromParent(parentId, "enquiryHeadingScroller", "div");
		headingSizer = getChildElementFromParent(parentId, "enquiryHeadingSizer", "div");
		dataSizer = getChildElementFromParent(parentId, "enquiryDataSizer", "div");
		dataDiv = getChildElementFromParent(parentId, "enquiryDataScroller", "div");		
	}
	else
	{		
